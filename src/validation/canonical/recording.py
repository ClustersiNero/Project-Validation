...
def record_roll(execution: RollExecution) -> RollRecord:
    return RollRecord(
        ...
        fill_start_indices=list(execution.fill_start_indices),
        fill_end_indices=list(execution.fill_end_indices),
        roll_pre_fill_state=record_optional_board(execution.pre_fill_state),
        roll_filled_state=record_optional_board(execution.filled_state),
        roll_cleared_state=record_optional_board(execution.cleared_state),
        roll_gravity_state=record_optional_board(execution.gravity_state),
